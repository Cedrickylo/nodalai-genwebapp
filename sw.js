// Incremented to v38 for September 9 changelog, native PWA browser frame controls (minimal-ui), and 30/60/90/120Hz adaptive transitions
const CACHE_NAME = 'nodal-ai-cache-v38';
